...
_RISK_ENV_MAP = {
    ...
    "liquidation_scan_enabled": "LIQUIDATION_SCAN_ENABLED",
    "liquidation_collateral_assets": "LIQUIDATION_COLLATERAL_ASSETS",
    "liquidation_scan_interval_seconds": "LIQUIDATION_SCAN_INTERVAL_SECONDS",
    "liquidation_scan_lookback_blocks": "LIQUIDATION_SCAN_LOOKBACK_BLOCKS",
